...
const Home = () => {
  return (
    <div className="flex justify-center h-screen relative ">
      <div className="absolute w-1/2 h-1/2 left-1/2 transform -translate-x-1/2 bg-cover bg-center z-0 md: w-full h-full" style={{ backgroundImage: 'url(/images/citybg.jpg)' }}></div>
