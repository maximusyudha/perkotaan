...
const ReportPage = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await axios.post(
        `${process.env.NEXT_PUBLIC_API_BASE_URL_SECRET}/project/submission/${decodedCookie.id}`,
        formDataToSend
      );
        ...
        <div className="flex items-center justify-center min-h-screen">
          ...
          <div className="modal-content bg-white p-8 rounded shadow-lg">
            <p className="text-lg font-semibold mb-4">
              Data anda telah berhasil terkirim
            </p>
  ...
  return (
    <div className="max-w-2xl mx-auto mt-10 mb-10">
      <h1 className="text-3xl items-center ml-36 font-bold mb-4">
        Buat Pengajuan Pembangunan
      </h1>
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        <div className="text-gray-400 text-[12px] ml-4">
          Foto harus diambil dalam keadaan sebenarnya/aktual, karena foto akan
          di verifikasi oleh pemerintah pusat
        </div>
        ...
        <div className="text-gray-400 text-[12px] ml-4">
          Proposal wajib ditanda tangani oleh pemerintah setempat yang
          berwenang(RT/RW, Desa/Kecamatan, Kabupaten/Kota) Agar keaslian
