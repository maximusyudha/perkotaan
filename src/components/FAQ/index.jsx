...
const FAQ = () => {
  ...
  return (
    <div className="max-w-[1440px] mx-auto px-6 pt-32 pb-10">
      <div className="flex flex-col justify-center items-center gap-8">
        <div className="text-center">
          <div className="text-4xl font-medium font-['Neue Montreal'] tracking-wide text-neutral-900">
            Pertanyaan yang sering ditanyakan
          </div>
          <div className="mt-4 text-base font-normal font-['Neue Montreal'] leading-normal text-neutral-900">
...
const FAQItem = ({ question, isOpen, handleDivClick, content }) => {
  return (
    <div
      className="relative shadow-md rounded-xl p-4 cursor-pointer"
