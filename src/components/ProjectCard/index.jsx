      ...
      <div className="flex flex-col">
        ...
        <div className="flex-1 bg-white rounded-lg border p-4">
          ...
          <div className="flex justify-between items-center">
            <div>
              <div className="text-sm font-normal leading-normal tracking-tight">
                Nilai Proyek
              </div>
            ...
            <button
              ...
              className="px-3 py-1 rounded-[35px] border border-gray-500 text-sm font-medium tracking-tight"
            >
              Detail
            </button>
          </div>
